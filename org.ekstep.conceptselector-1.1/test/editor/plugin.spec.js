describe("Concept Selecotr:", function() {
    ...
    it("Should register event and  Instance should pass undefined", function(done) {
    ...
    it("Should Get concepts data and push to conceptarray", function(done) {
        ...
        pluginInstance.getConcept(0, 500, pluginInstance, function(respconcept){});
        expect(pluginInstance.getConcept).toHaveBeenCalled();
        done();
    });

    it("Should Get concepts data and push to conceptarray if Instance is undefined", function(done) {
        ...
        var Instance = undefined;
        spyOn(pluginInstance, "getConcept").and.callThrough();
        pluginInstance.getConcept(0, 500, Instance, function(respconcept){});
        expect(pluginInstance.getConcept).toHaveBeenCalled();
        done();
    });
    ...
    it("Should generate telemetry event and set pageid default if pageid is not available", function(done) {
